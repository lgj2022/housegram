      ...
      <form class="form_area" enctype="multipart/form-data" @submit="onSubmit">
        <div class="main_area">
          <div class="image_area">
            ...
            <label class="input_image_btn change_box active" for="input_img">
            ...
            <div style="float: left; margin: 0 0 0 1rem">
              <template>
                <img
                  ...
                  :src="`http://127.0.0.1:8887` + `/` + userInfo.profile_img"
                  alt=""
                  style="
                    `height: 2.5rem;
                    width: 2.5rem;
        ...
        <button class="btn btn-outline-dark rounded-pill col-3 mt-3 mb-3">
          작성
        </button>
      </form>
    </div>
...
import { registArticle } from "@/api/Article.js";
